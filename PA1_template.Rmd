...
```
The mean is **`r totalStepsPerDay.mean`** and the median is **`r totalStepsPerDay.median`**.
...
```
The mean is **`r totalStepsPerDay.mean.new`** and the median is **`r totalStepsPerDay.median.new`**.
